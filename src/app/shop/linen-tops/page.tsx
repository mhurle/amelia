...
export default function LinenTops() {
  const products: Product[] = [
    { name: 'Embroidered Sage Top', price: '£115', description: 'Relaxed fit with delicate leaf embroidery', image: '/items/sage-embroidered-top-1.jpg', href: '/shop/linen-tops/embroidered-sage-top' },
    { name: 'Leaf Detail Linen Top', price: '£105', description: 'Handcrafted botanical details, timeless elegance', image: '/items/pastel-olive2.jpg', href: '/shop/linen-tops/leaf-detail-linen-top' }
  ]
