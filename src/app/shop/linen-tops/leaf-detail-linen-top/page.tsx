...
export default function LeafDetailLinenTop() {
      ...
      <div className="section-padding pt-8 pb-4">
        <div className="max-container">
          <nav className="text-sm text-navy/60">
            ...
            <span className="mx-2">/</span>
            <span className="text-navy">Leaf Detail Linen Top</span>
          </nav>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="relative aspect-[3/4] bg-cream rounded-sm overflow-hidden">
              <Image
                ...
                alt="Leaf Detail Linen Top - Handcrafted botanical embroidery on sage green linen"
                fill
            ...
            <div className="flex flex-col">
              <div className="mb-8">
                ...
                <p className="text-navy/80 text-lg leading-relaxed mb-4">
                  An elegant linen top showcasing intricate handcrafted botanical embroidery. 
                  The timeless sage green shade and classic cut create a versatile piece that 
                  elevates any wardrobe with its artisanal charm.
                </p>
                ...
                <div className="border-b border-sand/30 pb-4">
                  ...
                  {openSection === 'description' && (
                    <div className="mt-4 text-navy/80 text-sm leading-relaxed space-y-3">
                      ...
                      <p>• Intricate hand-embroidered leaf motifs</p>
                      <p>• Classic tailored fit</p>
                      <p>• Long sleeves with button cuffs</p>
                      <p>• Button-front closure with covered placket</p>
                      ...
                      <p className="pt-2 border-t border-sand/20">
                        ...
                        This top runs true to size with a classic fit.
                      </p>
                    </div>
                  )}
                </div>
                ...
                <div className="border-b border-sand/30 pb-4">
                  ...
                  {openSection === 'care' && (
                    <div className="mt-4 text-navy/80 text-sm leading-relaxed space-y-2">
                      ...
                      <p className="pt-2 border-t border-sand/20">
                        The artisanal embroidery requires gentle care. Linen naturally softens with each wash, 
                        developing a beautiful lived-in texture that enhances the handcrafted details.
                      </p>
                    </div>
                  )}
                </div>
      ...
      <div className="section-padding py-20 bg-sand/10">
        <div className="max-container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { name: 'Embroidered Sage Top', price: '£115', href: '/shop/linen-tops/embroidered-sage-top' },
