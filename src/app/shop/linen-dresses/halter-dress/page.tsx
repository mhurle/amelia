...
export default function HalterDress() {
      ...
      <div className="section-padding pt-8 pb-4">
        <div className="max-container">
          <nav className="text-sm text-navy/60">
            ...
            <Link href="/shop/linen-dresses" className="hover:text-navy transition-colors">Linen Dresses</Link>
            <span className="mx-2">/</span>
            <span className="text-navy">Halter Dress</span>
          </nav>
        </div>
      </div>
        ...
        <div className="max-container">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="relative aspect-[3/4] bg-cream rounded-sm overflow-hidden">
              <Image
                src="/items/dress.jpg"
                alt="Linen Halter Dress - White linen halter dress with coastal backdrop"
                fill
            ...
            <div className="flex flex-col">
              <div className="mb-8">
                ...
                <p className="text-navy/80 text-lg leading-relaxed mb-4">
                  The Halter Dress is a beautiful, elegant linen dress with an adjustable 
                  tie neckline and flowing silhouette. The ultimate coastal staple.
                </p>
                ...
                <div className="border-b border-sand/30 pb-4">
                  ...
                  {openSection === 'description' && (
                    <div className="mt-4 text-navy/80 text-sm leading-relaxed space-y-3">
                      ...
                      <p>• Halter neckline with adjustable tie closure</p>
                      <p>• Relaxed fit through body</p>
                      <p>• Mini to midi length</p>
                ...
                <div className="border-b border-sand/30 pb-4">
                  ...
                  {openSection === 'care' && (
                    <div className="mt-4 text-navy/80 text-sm leading-relaxed space-y-2">
                      ...
                      <p>• Iron while slightly damp for best results</p>
                      <p>• Do not bleach or dry clean</p>
                      <p className="pt-2 border-t border-sand/20">
                        Linen naturally softens with each wash, developing a beautiful lived-in texture over time.
                      </p>
                    </div>
                  )}
                </div>
      ...
      <div className="section-padding py-20 bg-sand/10">
        <div className="max-container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { name: 'Linen Cardigan', price: '£95' },
              { name: 'Woven Sandals', price: '£65' },
